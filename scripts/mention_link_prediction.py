"""
User-to-User Mention Link Prediction (no reply nodes)
======================================================
Unique to this variant:
- output_dir: results/user_mention_link_prediction
- num_layers = 3
- No replies / reply_mention_rel tables
"""
...
CONFIG = {
    ...
    "graph_cache_dir": "./user_mention_materialized_cache",
    # ====hyper-parameters====
    "lr": 0.001,
    "epochs": 20,
    "batch_size": 512,
...
def main():
    ...
    ExperimentRunner(
        ...
        experiment_title="User-to-User Mention Link Prediction Experiment",
    ).run()
